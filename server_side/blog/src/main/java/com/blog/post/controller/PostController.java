...
public class PostController {
    ...
    @GetMapping("/profile")
    public ResponseEntity<?> GetPosts(Authentication authentication,@RequestHeader("Authorization") String authorizationHeader) {
        try {
            String jwt = authorizationHeader.substring(7);
            ...
            List<PostResponseDto> postDtos = posts.stream()
                    .map(post -> PostResponseDto.fromEntity(post, false))
